...
var (
	...
	sailomFlag = flog.bool("sailom", false, "Initializes the faucet with Sailom network config")
)
...
func main() {
	...
	genesis, err := getGenesis(*genesisFlag, *goerliFlag, *sepoliaFlag, *ariFlag, *sailomFlag)
	if err != nil {
...
func getGenesis(genesisFlag string, goerliFlag bool, sepoliaFlag bool, ariFlag bool, sailomFlag bool) (*core.Genesis, error) {
	switch {
	case genesisFlag != "":
	...
	case ariFlag:
		return core.DefaultAriGenesisBlock(), nil
	case sailomFlag:
		return core.DefaultSailomGenesisBlock(), nil
	default:
